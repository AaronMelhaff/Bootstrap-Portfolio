    ...
    <Navbar collapseOnSelect  bg='primary' variant="dark" expand='lg' className='px-4'>
        ...
        <Navbar.Collapse id='site-nav'>
            <Nav className='w-356px'>
              <Link to='/' exact className='btn btn-primary nav-btn'>
                  <span className='mr-1'>About</span>
                  <SVGIcon className='button-icon icon-sm' path={icons('about')}/>
              </Link>
              <Link to='/portfolio' className='btn btn-primary nav-btn'>
            ...
            <div className='d-flex justify-content-center justify-content-lg-end w-100' rel='noopener noreferrer'>
              ...
              <a className='btn btn-primary' href='https://github.com/AaronMelhaff/Bootstrap-Portfolio' target='_blank' rel='noopener noreferrer'>
